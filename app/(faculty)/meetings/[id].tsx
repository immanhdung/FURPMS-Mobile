        ...
        <View className="mb-5 gap-3">
          ...
          {meeting.linkedProposalTitle && (
            <View className="flex-row items-center gap-1.5">
              ...
              <Text className="text-violet-600 dark:text-violet-400 text-sm font-medium" numberOfLines={1}>
                {meeting.linkedProposalTitle}
              </Text>
            </View>
          )}
                ...
                <>
                  ...
                  <View className="flex-row items-center gap-3">
                    ...
                    <View className="flex-1">
                      <Text className="text-neutral-500 dark:text-dark-500 text-xs font-sans">Location</Text>
                      <Text className="text-neutral-900 dark:text-neutral-50 text-sm font-medium">
                        {meeting.location}
                      </Text>
                    </View>
              ...
              {meeting.videoLink && (
                <>
                  ...
                  >
                    ...
                    <View className="flex-1">
                      <Text className="text-neutral-500 dark:text-dark-500 text-xs font-sans">Video Link</Text>
